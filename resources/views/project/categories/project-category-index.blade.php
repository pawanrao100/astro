...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">{{clean( trans('niva-backend.project') , array('Attr.EnableID' => true))}} {{clean( trans('niva-backend.categories') , array('Attr.EnableID' => true))}}</h6>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <form action="{{route('delete.project-category')}}" method="POST" class="form-inline">
                        @csrf
                        @method('DELETE')
